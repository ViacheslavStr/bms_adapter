...
static void product_info_update(void)
{
    ...
    length = set_wifi_uart_buffer(length, (unsigned char *)"{\"p\":\"", (unsigned short)my_strlen((unsigned char *)"{\"p\":\""));
    length = set_wifi_uart_buffer(length,(unsigned char *)PRODUCT_KEY,(unsigned short)my_strlen((unsigned char *)PRODUCT_KEY));
    length = set_wifi_uart_buffer(length, (unsigned char *)"\",\"v\":\"", (unsigned short)my_strlen((unsigned char *)"\",\"v\":\""));
    length = set_wifi_uart_buffer(length,(unsigned char *)MCU_VER,(unsigned short)my_strlen((unsigned char *)MCU_VER));
    length = set_wifi_uart_buffer(length, (unsigned char *)"\",\"m\":", (unsigned short)my_strlen((unsigned char *)"\",\"m\":"));
    length = set_wifi_uart_buffer(length, (unsigned char *)CONFIG_MODE, (unsigned short)my_strlen((unsigned char *)CONFIG_MODE));
#ifdef CONFIG_MODE_DELAY_TIME
    sprintf((char *)str,",\"mt\":%d",CONFIG_MODE_DELAY_TIME);
    length = set_wifi_uart_buffer(length, str, (unsigned short)my_strlen(str));
#endif
    ...
    length = set_wifi_uart_buffer(length, (unsigned char *)"}", (unsigned short)my_strlen((unsigned char *)"}"));
...
{
    unsigned char value = 0;  // Initialize to avoid warning
