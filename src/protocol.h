...
******************************************************************************/
#define PRODUCT_KEY "9878vhvaswl0wzo0"    //The unique product identification generated after product is created on development platform
...
******************************************************************************/
//Battery Percentage (101) - Value, Range: 0-100, Scale: 0, Unit: %
#define DPID_STATE_OF_CHARGE 101
//Battery Current (102) - Value, Range: -200-200, Scale: 3, Unit: A (значение * 1000)
#define DPID_BATTERY_CURRENT 102
//Status (103) - Enum: charging, discharging, fault, idle
#define DPID_STATUS 103
//Cook Temperature (104) - Value, Range: -50-100, Scale: 0, Unit: °C
#define DPID_COOK_TEMPERATURE 104
